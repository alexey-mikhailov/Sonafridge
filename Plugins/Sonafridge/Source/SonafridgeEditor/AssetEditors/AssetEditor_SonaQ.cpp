...
void FAssetEditor_SonaQ::NotifyPostChange(const FPropertyChangedEvent& PropertyChangedEvent,
                                          FProperty*                   PropertyThatChanged)
{
	if (SonaQWidget && SonaQPreset)
	{
		const FName PropertyName = PropertyThatChanged->GetFName();
		// TODO: implement SonaQWidget->NotifyPresetChanged(PropertyName);
	}
}
