...
public:
	...
	DECLARE_EVENT_TwoParams(UNaveledKnob, FNavelValueChanged, float OldValue, float NewValue)
	...
	float KnobValue01 = 0.f;

	UPROPERTY(BlueprintReadWrite, EditAnywhere, meta = (UIMin = 0.f, UIMax = 1.f))
	float NavelValue01 = 0.f;
	...
	void SetKnobValue01(float InKnobValue01);
	void SetNavelValue01(float InKnobValue01);
